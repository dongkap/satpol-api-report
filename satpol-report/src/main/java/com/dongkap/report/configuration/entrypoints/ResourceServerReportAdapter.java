package com.dongkap.report.configuration.entrypoints;
...
public class ResourceServerReportAdapter extends ResourceServerConfigurerAdapter {

    private AccessDeniedHandler accessDeniedHandler;
    private AuthenticationEntryPoint authenticationEntryPoint;

    private String resourceId = ResourceCode.REPORT;
    private String resourcePath = ResourceCode.REPORT_PATH;
    
    public ResourceServerReportAdapter() {}
    public ResourceServerReportAdapter(AccessDeniedHandler accessDeniedHandler, AuthenticationEntryPoint authenticationEntryPoint) {
